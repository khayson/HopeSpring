...
export default function About({ team, milestones, stats, partners, settings }: AboutProps) {
        ...
        <PublicLayout currentPath="/about">
            ...
            <section className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
                <div className="grid gap-12 md:grid-cols-2">
                    <div>
                        <h2 className="font-serif text-3xl font-bold text-navy">Our Mission</h2>
                        <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                            {settings.about_mission || 'To empower underserved communities in Ghana through sustainable clean water, education, healthcare, and community development programmes.'}
                        </p>
                    </div>
                    <div>
                        <h2 className="font-serif text-3xl font-bold text-navy">Our Vision</h2>
                        <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                            {settings.about_vision || 'A Ghana where every community has access to clean water, quality education, and essential healthcare.'}
                        </p>
                    </div>
                </div>
            </section>
            ...
            {milestones.length > 0 && (
                <section className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
                    <h2 className="mb-10 text-center font-serif text-3xl font-bold text-navy">Our Journey</h2>
            ...
            {staff.length > 0 && (
                <section className="mx-auto max-w-7xl px-4 py-16 md:px-6">
                    <h2 className="mb-10 text-center font-serif text-2xl font-bold text-navy">Our Team</h2>
                    <div className="grid gap-8 sm:grid-cols-3 lg:grid-cols-5">
                        {staff.map((member) => (
                            <TeamCard key={member.id} name={member.name} role={member.role} image={member.photo ?? undefined} />
                        ))}
                    </div>
                </section>
            )}
            ...
            {board.length > 0 && (
                <section className="bg-secondary/50 px-4 py-12 md:px-6">
                    <div className="mx-auto max-w-7xl">
                        <h2 className="mb-10 text-center font-serif text-2xl font-bold text-navy">Board of Directors</h2>
