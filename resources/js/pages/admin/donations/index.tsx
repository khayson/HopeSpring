                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-xl border border-sidebar-border/70 bg-white p-5 dark:border-sidebar-border dark:bg-neutral-900">
                        ...
                        <p className="mt-2 text-2xl font-bold tracking-tight">
                            {formatCurrency(totals.successful)}
                        </p>
                    </div>
                    <div className="rounded-xl border border-sidebar-border/70 bg-white p-5 dark:border-sidebar-border dark:bg-neutral-900">
                        <p className="text-sm font-medium text-muted-foreground">
                                ...
                                >
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <p className="truncate text-xs text-muted-foreground">
                                            {donation.donor_email} &middot;{' '}
                                            {donation.programme ||
                                                'General Fund'}
                                        </p>
                                    </div>
                                    <span
                                        className={`mx-3 shrink-0 rounded-full px-2 py-0.5 text-xs font-semibold capitalize ${statusColors[donation.status] ?? 'bg-secondary'}`}
                                    >
                                        {donation.status}
                                    </span>
